...
module Strings
  ...
  def Strings.starting_attribute_points(starting_points)
    "Starting attribute points spent are #{starting_points}. You may use [3, 4, 5] in any order."
  end
  ...
  def Strings.starting_skill_points(starting_points)
    "Starting skill points spent are #{starting_points}. You may use [4, 7, 11] in any order"
  end
